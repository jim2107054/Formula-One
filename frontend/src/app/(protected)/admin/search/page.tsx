...
export default function SearchPage() {
  ...
  return (
    <Box className="p-6">
      <Heading size="7" className="mb-2">Intelligent Search</Heading>
      <Text className="text-gray-600 mb-6">
        Search course materials using natural language. Find relevant documents, code snippets, and notes.
      </Text>
      ...
      <Card className="p-6 mb-6">
        <Flex gap="4" align="end" wrap="wrap">
          <Box className="flex-1 min-w-[300px]">
            ...
            <TextField.Root
              size="3"
              placeholder="Enter your search query, e.g., 'binary search algorithm' or 'how to create a database connection'"
              value={query}
                  ...
                  >
                    <Flex justify="between" align="start">
                      <Flex gap="3" align="start" className="flex-1">
                        <Box className="p-2 rounded bg-[var(--Accent-light)]">
